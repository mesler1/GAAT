...
- Apr 06, 2026 (**v3.05.52**): **Checkpoint system, plan mode, compact, and utility commands** (Appreciate the contribution from [@mxh1999](https://github.com/mxh1999), merged from [PR #19](https://github.com/SafeRL-Lab/clawspring/pull/19))
